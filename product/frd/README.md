...
| Fleet Management | [fleet-management.md](fleet-management.md) | Mobile + API + Web Admin | **Planned** | Organizations (admin-created), lifecycle templates, vehicle inventory, driver assignments, work orders, inspections, cost analytics (TCO/lemon), warranty templates, ownership transfer, workshop accounts, CSV import. Phase 3 (Year 2). |
